...
def home(request):
    ...
    return render(request, 'heroverse/newsfeed.html', context)
...
def register(request):
    ...
    context = {'form':form}
    return render(request, 'heroverse/register.html', context)
...
def profile(request, username):
    ...
    return render(request, 'heroverse/profile.html', context)
...
def editar(request):
    ...
    return render(request, 'heroverse/editar.html', context)
